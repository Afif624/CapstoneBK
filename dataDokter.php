...
if (isset($_POST['save'])){
  ...
  $queriduplikatusername = mysqli_query($mysqli, "SELECT * FROM dokter WHERE username=$username_baru");
  if ($queriduplikatusername->num_rows > 0){
      echo "<script>alert('Username sudah digunakan!')</script>";
  }  else {
    $queriduplikatnohp = mysqli_query($mysqli, "SELECT * FROM dokter WHERE no_hp=$no_hp_baru");
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" data-inputmask='"mask": "999-999-999-999"' data-mask 
